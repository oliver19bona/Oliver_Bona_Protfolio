  ...
  <section id="experience">
	...
	<AnimateOnVisible name="fadeUp" :duration="1">
		<div class="container-fluid">
			<div 	class="col-1 col-md middle">
      <center>
      <a href="https://drive.google.com/file/d/17QiVYQqWswlT0B8IackNbXncf060X5Pn/view"><button class="btn btn-success">DOWNLOAD</button></a>
      </center>
			</div>
		</div>
	<ExperienceColumn 
